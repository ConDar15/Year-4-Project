...
int main(int argc, char **argv)
{
	...
	char line[1024];
	clock_t *time[4], t;
	char *name[4] = {"geometric_acos", "taylor_acos", 
					 "cordic_acos", "builtin_acos"};
